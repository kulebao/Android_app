...
public class DataMgr {
	...
	private IMGroupMgr iMGroupMgr;
	private GroupMemberMgr groupMemberMgr;
	...
	public DataMgr() {
		...
		groupMemberMgr = new GroupMemberMgr(dbHelper);
	}
	...
	public Teacher getTeacherByInternalID(int internalid) {
		return teacherMgr.getTeacherByInternalID(internalid);
	}
	...
	public void updateParentInfo(ParentInfo info, String parentid) {
		parentMgr.updateAll(info, parentid);
	}
	...
	public List<IMExpandInfo> getClassMemberInfo(String classid) {
		return groupMemberMgr.getClassMemberInfo(classid);
	}
	...
	public void replace(NativeMediumInfo info) {
		nativeMediumMgr.replace(info);
	}
	...
	public void deleteGroup(String groupid) {
		iMGroupMgr.deleteGroup(groupid);
	}

	public List<IMGroupInfo> getAllIMGroupInfo() {
		return iMGroupMgr.getAllIMGroupInfo();
	}
