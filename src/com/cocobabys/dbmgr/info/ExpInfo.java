...
public class ExpInfo{
    ...
    public String serverUrlToLocalUrl(String serverUrl, boolean bThumbnail){
        ...
        if(sender_id.equals(DataMgr.getInstance().getSelfInfoByPhone().getParent_id())){
            ...
            if(JSONConstant.IMAGE_TYPE.equals(getMediumType()) || !bThumbnail){
                NativeMediumInfo nativeMediumInfo = DataMgr.getInstance().getNativeMediumInfo(Utils.getName(serverUrl));
            ...
            localUrl = serverUrl.replace(UploadFactory.getUploadHost(), Utils.getSDCardPicRootPath() + File.separator);
    ...
    public String buildShareUrl(){
        return String.format(ServerUrls.EXP_SHARE_URL, DataMgr.getInstance().getSchoolID(), DataMgr.getInstance()
                .getSelectedChild().getServer_id(), getExp_id());
