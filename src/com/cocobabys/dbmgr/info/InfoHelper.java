...
public class InfoHelper{
    ...
    public static String getParentInfo(){
        ...
        try{
            jsonObject.put("school_id", Integer.parseInt(DataMgr.getInstance().getSchoolID()));
            jsonObject.put(ParentInfo.PARENT_ID, selfInfoByPhone.getParent_id());
            jsonObject.put(ParentInfo.PARENT_NAME, selfInfoByPhone.getName());
            jsonObject.put(ParentInfo.MEMBER_STATUS, selfInfoByPhone.getMember_status());
            jsonObject.put(ParentInfo.PHONE, selfInfoByPhone.getPhone());
            jsonObject.put(ParentInfo.PORTRAIT, selfInfoByPhone.getPortrait());
            jsonObject.put("gender", 0);
            jsonObject.put("birthday", "1980-1-1");
            jsonObject.put(ParentInfo.TIMESTAMP, selfInfoByPhone.getTimestamp());
        } catch(JSONException e){
            e.printStackTrace();
        }
