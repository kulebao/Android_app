...
public class PlayActivity extends UmengStatisticsActivity{
    ...
    private boolean               mIfLogin                 = false;         // If
                                                                             // login...
    private boolean               mIsPlaying               = false;         // Is
                                                                             // playing
                                                                             // video...
    private boolean               mIsListening             = false;         // Is
                                                                             // listening...
    private boolean               mIsTalking               = false;         // Is
                                                                             // talking...
    private boolean               mIsRecording             = false;         // Is
                                                                             // Recording...
    ...
    private boolean playVideo(){
        ...
        VideoApp.getJni().setNetworkCallback(VideoApp.mUserId, new NetworkCallback(){
            @Override
                                     ...
                                     public void handleMessage(Message msg){
                                         switch(msg.what){
                                             case MSG_SHOW_RECORD_TIME:
                                                 int time = VideoApp.getJni()
                                                         .getLocalRecordTime(VideoApp.mRecordHandle);
