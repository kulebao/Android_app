...
public class ChatActivity extends UmengStatisticsActivity{
        ...
        camera.setOnClickListener(new MyClickListner(){
            ...
            public void execute(){
                if(!Utils.isSdcardExisting()){
                    Toast.makeText(ChatActivity.this, "未找到存储卡，无法保存图片！", Toast.LENGTH_LONG).show();
                    return;
                }
    ...
    private void initCustomListView(){
        ...
        adapter = new ChatListAdapter(this, chatlist, downloadImgeJob, getTeacherInfoJob);
            ...
            public void handleMessage(Message msg){
                ...
                switch(msg.what){
                    ...
                    case EventType.GET_CHAT_FAIL:
                        Toast.makeText(ChatActivity.this, "获取数据失败", Toast.LENGTH_SHORT).show();
                        break;
                    default:
                        break;
                }
    ...
    private abstract class MyClickListner implements android.view.View.OnClickListener{
        ...
        public void onClick(View v){
            if(!Utils.isNetworkConnected(ChatActivity.this)){
                Toast.makeText(ChatActivity.this, R.string.net_error, Toast.LENGTH_SHORT).show();
                return;
            }
