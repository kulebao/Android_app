...
public class SettingActivityOld extends UmengStatisticsActivity{
    ...
    private void initView(){
        ...
        exitLogin.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View v){
                Utils.showTwoBtnResDlg(R.string.confirm_exit, SettingActivityOld.this,
    ...
    private void initHandler(){
        ...
        handler = new MyHandler(this, dialog){
            ...
            public void handleMessage(Message msg){
                if(SettingActivityOld.this.isFinishing()){
                ...
                switch(msg.what){
                    ...
                    case EventType.HAS_NO_VERSION:
                        Toast.makeText(SettingActivityOld.this, R.string.no_new_version, Toast.LENGTH_SHORT).show();
                        break;
                    default:
                        break;
                }
