...
public class SchoolNoticeActivity extends TabChildActivity{
    ...
    private Map<Integer, Integer>          map                 = new HashMap<Integer, Integer>(){
...

                                                                   {
                                                                       ...
                                                                       put(R.drawable.education,
                                                                           R.string.want_estimation);
            ...
            public void handleMessage(Message msg){
                ...
                switch(msg.what){
                    ...
                    case EventType.SERVER_INNER_ERROR:
                        Toast.makeText(SchoolNoticeActivity.this, R.string.get_child_info_fail, Toast.LENGTH_SHORT)
                                .show();
                        break;
                    ...
                    case EventType.JOIN_IM_GROUP_FAIL:
                        Toast.makeText(SchoolNoticeActivity.this, R.string.join_group_failed, Toast.LENGTH_SHORT)
                                .show();
                        break;
                    default:
                        break;
