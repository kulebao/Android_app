...
public class NewHomeworkPullRefreshActivity extends UmengStatisticsActivity{
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.new_homework_pull_refresh_list);
    ...
    private void initHander(){
        myhandler = new MyHandler(this, dialog){
            ...
            public void handleMessage(Message msg){
                ...
                if(NewHomeworkPullRefreshActivity.this.isFinishing()){
                ...
                switch(msg.what){
                    case EventType.SUCCESS:
                        ...
                        break;
                    case EventType.FAIL:
                        Toast.makeText(NewHomeworkPullRefreshActivity.this, "获取数据失败", Toast.LENGTH_SHORT).show();
                        break;
                    default:
                        break;
                }
