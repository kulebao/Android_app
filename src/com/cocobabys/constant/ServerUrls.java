...
public class ServerUrls{
    ...
    public static final String  DELETE_EXP              = getHost() + ROOT_RES_PATH + "/%s/" + EXP_RES_PATH + "/%s/"
                                                                + RECORD_RES_PATH + "/%d";

    // https://stage2.cocobabys.com/api/v1/kindergarten/2088/video_member/222
    public static final String  GET_VIDEO_INFO          = getHost() + "api/v1/" + ROOT_RES_PATH + "/%s/" + VIDEO_MEMBER
                                                                + "/%s";
