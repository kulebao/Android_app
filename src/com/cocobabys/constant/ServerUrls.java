...
public class ServerUrls{
    ...
    public static final String  GET_SWIPE_RECORD            = getHost() + ROOT_RES_PATH + "/%s/" + CHILD_RES_PATH
                                                                    + "/%s/" + DAILYLOG;
    ...
    public static final String  GET_EDUCATION               = getHost() + ROOT_RES_PATH + "/%s/" + CHILD_RES_PATH
                                                                    + "/%s/" + EDU_RES_PATH + "?";
    ...
    public static final String  GET_NEW_CHAT                = getHost() + ROOT_RES_PATH + "/%s/" + CHAT_SESSION
                                                                    + "/%s/" + RECORD_RES_PATH + "?";

    // https://stage2.cocobabys.com/kindergarten/1003/session/1_1396844597394
    public static final String  SEND_NEW_CHAT               = getHost() + ROOT_RES_PATH + "/%s/" + CHAT_SESSION
                                                                    + "/%s/" + RECORD_RES_PATH;
    ...
    public static final String  GET_ALL_CHILDREN_INFO       = getHost() + ROOT_RES_PATH + "/%s/" + PARENT_RES_PATH
                                                                    + "/%s/" + CHILD_RES_PATH;
    ...
    public static final String  UPLOAD_CHILD_INFO           = getHost() + ROOT_RES_PATH + "/%s/" + CHILD_RES_PATH
                                                                    + "/%s";
    ...
    public static final String  SCHEDULE_PRIVIEW            = getHost() + ROOT_RES_PATH + "/%s/" + CLASS_RES_PATH
                                                                    + "/%s/" + SCHEDULE_RES_PATH + "/"
                                                                    + GET_TYPE_PREVIEW;

    public static final String  GET_SCHEDULE                = getHost() + ROOT_RES_PATH + "/%s/" + CLASS_RES_PATH
                                                                    + "/%s/" + SCHEDULE_RES_PATH + "/%s";

    public static final String  COOKBOOK_PRIVIEW            = getHost() + ROOT_RES_PATH + "/%s/" + COOKBOOK_RES_PATH
                                                                    + "/" + GET_TYPE_PREVIEW;

    public static final String  COOKBOOK_DETAIL             = getHost() + ROOT_RES_PATH + "/%s/" + COOKBOOK_RES_PATH
                                                                    + "/%s";

    public static final String  GET_EXP_COUNT               = getHost() + ROOT_RES_PATH + "/%s/" + EXP_RES_PATH
                                                                    + "/%s/" + STATISTICS_RES_PATH + "?";

    public static final String  GET_EXP_INFO                = getHost() + ROOT_RES_PATH + "/%s/" + EXP_RES_PATH
                                                                    + "/%s/" + RECORD_RES_PATH + "?";

    public static final String  POST_EXP_INFO               = getHost() + ROOT_RES_PATH + "/%s/" + EXP_RES_PATH
                                                                    + "/%s/" + RECORD_RES_PATH;

    public static final String  DELETE_CHAT                 = getHost() + ROOT_RES_PATH + "/%s/" + CHAT_SESSION
                                                                    + "/%s/" + RECORD_RES_PATH + "/%d";

    // https://stage2.cocobabys.com/kindergarten/2088/history/2_2088_896/record/583
    public static final String  DELETE_EXP                  = getHost() + ROOT_RES_PATH + "/%s/" + EXP_RES_PATH
                                                                    + "/%s/" + RECORD_RES_PATH + "/%d";

    // https://stage2.cocobabys.com/api/v1/kindergarten/2088/video_member/222
    public static final String  GET_VIDEO_INFO              = getHost() + "api/v1/" + ROOT_RES_PATH + "/%s/"
                                                                    + VIDEO_MEMBER + "/%s";
    ...
    public static final String  GET_LAST_LOCATION           = getHost() + "api/v2/" + LOCATION_PATH + "/%s/"
                                                                    + "record?most=1";
    ...
    public static final String  GET_LOCATOR_POWER           = getHost() + "api/v2/" + LOCATION_PATH + "/%s/"
                                                                    + "status/power";
    ...
    public static final String  GET_BUSINESS_STATE          = getHost() + "api/v4/kindergarten/%s/"
                                                                    + COMMERCIAL_SUMMARY;
    ...
    public static final String  GET_MERCHANT_ACTION_LIST    = getHost() + "api/v4/kindergarten/%s/" + CONTRACTOR
                                                                    + "/%d/" + ACTIVITY;
    ...
    public static final String  DO_ENROLL                   = getHost() + "api/v4/kindergarten/%s/" + ACTIVITY + "/%d/"
                                                                    + ENROLLMENT;

    // 获取分享成长经历的token
    public static final String  EXP_SHARE_URL               = getHost() + "api/v3/kindergarten/%s/" + EXP_RES_PATH
                                                                    + "/%s/" + RECORD_RES_PATH + "/%s/" + SHARE;

    // 真正的分享链接
    public static final String  EXP_SHARE_REAL_URL          = getHost() + "s" + "/%s";

    // /api/v5/kindergarten/:schoolId/invitation
    public static final String  INVITE_URL                  = getHost() + "api/v5/" + ROOT_RES_PATH + "/%s/"
                                                                    + INVITATION;
