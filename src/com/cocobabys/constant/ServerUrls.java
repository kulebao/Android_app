...
public class ServerUrls {
	...
	public static final String GET_NOTICE_WITH_TAGS = getHost() + FIX_PATH
	...
	public static final String GET_AD_INFO = getHost() + "api/v1/"
			+ ROOT_RES_PATH + "/%s/" + AD;

	// https://stage2.cocobabys.com/api/v2/location/1451351909/record?most=1
	public static final String GET_LAST_LOCATION = getHost() + "api/v2/"
			+ LOCATION_PATH + "/%s/" + "record?most=1";

	// https://stage2.cocobabys.com/api/v2/location/1451351909/record
	public static final String GET_HISTORY_LOCATION = getHost() + "api/v2/"
			+ LOCATION_PATH + "/%s/" + "record";

	// https://stage2.cocobabys.com/api/v2/location/1451351909/status/power
	public static final String GET_LOCATOR_POWER = getHost() + "api/v2/"
			+ LOCATION_PATH + "/%s/" + "status/power";

	public static final String GET_SCHOOL_CONFIG = getHost()
			+ "api/v2/school_config/%s";

	// https://stage2.cocobabys.com/api/v1/kindergarten/2088/video_member/default
	public static final String GET_PUBLIC_VIDEO_INFO = getHost()
			+ "api/v1/kindergarten/%s/video_member/default";

	// https://stage2.cocobabys.com/api/v2/kindergarten/2088/news/123/reader
	public static final String POST_NEWS_RECEIPT = getHost()
			+ "api/v2/kindergarten/%s/" + NEWS_RES_PATH + "/%d/reader";

	public static final String GET_RECEIPT_STATE = getHost()
			+ "api/v2/kindergarten/%s/" + NEWS_RES_PATH + "/%d/reader/%s";

	// https://stage2.cocobabys.com/api/v2/kindergarten/2088/last_bus_location/2_2088_897
	public static final String GET_SCHOOLBUS_LAST_LOCATION = getHost()
			+ "api/v2/kindergarten/%s/" + LAST_BUS_LOCATION + "/%s";

	// https://stage2.cocobabys.com/api/v4/kindergarten/2088/contractor
	public static final String GET_MERCHANT_LIST = getHost()
			+ "api/v4/kindergarten/%s/" + CONTRACTOR;

	// https://stage2.cocobabys.com/api/v4/kindergarten/2088/activity
	public static final String GET_ACTION_LIST = getHost()
			+ "api/v4/kindergarten/%s/" + ACTIVITY;

	// https://stage2.cocobabys.com/api/v4/kindergarten/2088/activity/:activityId/parent/:parentId/enrollment
	public static final String GET_ENROLL_STATE = getHost()
			+ "api/v4/kindergarten/%s/" + ACTIVITY + "/%d/" + PARENT_RES_PATH
			+ "/%s/" + ENROLLMENT;

	// https://stage2.cocobabys.com/api/v4/kindergarten/2088/activity/:activityId/enrollment
	public static final String DO_ENROLL = getHost()
			+ "api/v4/kindergarten/%s/" + ACTIVITY + "/%d/" + ENROLLMENT;

	// 获取分享成长经历的token
	public static final String EXP_SHARE_URL = getHost()
			+ "api/v3/kindergarten/%s/" + EXP_RES_PATH + "/%s/"
