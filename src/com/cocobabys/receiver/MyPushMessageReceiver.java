...
public class MyPushMessageReceiver extends PushMessageReceiver{
    ...
    public void onBind(Context context, int errorCode, String appid, String userId, String channelId, String requestId){
        String responseString = "onBind errorCode=" + errorCode + " appid=" + appid + " userId=" + userId
                + " channelId=" + channelId + " requestId=" + requestId + " phone=" + DataUtils.getAccount();
    ...
    private void sendErrorToSercice(Context context, String responseString){
        try{
            ...
            myintent.putExtra(ConstantValue.SERVICE_COMMAND, ConstantValue.COMMAND_TYPE_SEND_BIND_ERROR);
    ...
    public void onMessage(Context context, String message, String customContentString){
        ...
        if(DataUtils.isLoginout()){
            ...
            Log.i("DDD", "EEE logout do not receive any msg");
            return;
        }
    ...
    public static void setCustomNotification(Notice notice, Context context){
        ...
        Notification notif = new Notification(R.drawable.small_logo, notice.getTicker(), System.currentTimeMillis());
    ...
    private static RemoteViews getRemoteView(Notice notice, Context context){
        ...
        mRemoteViews.setTextViewText(R.id.tv_custom_content, notice.getContent());
    ...
    private static CharSequence getCurrentTime(){
        SimpleDateFormat sDateFormat = new SimpleDateFormat("hh:mm", Locale.CHINESE);
    ...
    public void onSetTags(Context context, int errorCode, List<String> sucessTags, List<String> failTags,
        ...
        Log.d(TAG, "EEE tag=" + responseString);
        DataUtils.saveUndeleteableProp(JSONConstant.PUSH_TAGS, listToString(sucessTags));
    }
