...
public class StudyNoticePaser implements NoticePaser {
    ...
    public Notice saveData(JSONObject object) {
        ...
        try {
            ...
            String ticker = context.getResources().getString(R.string.study);
            notice.setType(JSONConstant.NOTICE_TYPE_STUDY);
