...
public class SqliteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS " + NEWS_TAB + "(" + News.ID
                ...
                + News.NEWS_SERVER_ID + " integer," + News.PUBLISHER + " varchar," + "UNIQUE("
                + News.NEWS_SERVER_ID + ") " + ")");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS " + HOMEWORK_TAB + "(" + Homework.ID
                + " integer primary key autoincrement," + Homework.TITLE + " varchar,"
                + Homework.CONTENT + " varchar," + Homework.TIMESTAMP + " biginteger ,"
                + Homework.ICON_URL + " varchar," + Homework.SERVER_ID + " integer,"
                + Homework.PUBLISHER + " varchar," + "UNIQUE(" + Homework.SERVER_ID + ") " + ")");

        db.execSQL("CREATE TABLE IF NOT EXISTS " + CHAT_TAB + "(" + ChatInfo.ID
                + " integer primary key autoincrement," + ChatInfo.SENDER + " varchar,"
