...
public class SqliteHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		db.execSQL("CREATE TABLE IF NOT EXISTS " + NOTICE_TAB + "(" + Notice.ID
				+ " integer primary key autoincrement," + Notice.TITLE
				+ " varchar," + Notice.CONTENT + " varchar," + Notice.TIMESTAMP
				+ " timestamp ," + Notice.NOTICE_TYPE + " integer,"
				+ Notice.PUBLISHER + " varchar," + Notice.READ + " integer,"
				+ Notice.CHILD_ID + " varchar" + ")");
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS " + NEWS_TAB + "(" + News.ID
				...
				+ " varchar," + "UNIQUE(" + News.NEWS_SERVER_ID + ") " + ")");
