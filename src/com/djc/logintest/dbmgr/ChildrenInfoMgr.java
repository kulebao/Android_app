...
public class ChildrenInfoMgr {
    ...
    long addChildrenInfo(ChildInfo info) {
        ...
        return writableDatabase.insert(SqliteHelper.CHILDREN_INFO_TAB, null, values);
    }
    ...
    void updateLocalUrl(String serverid, String localurl) {
        ...
        db.update(SqliteHelper.CHILDREN_INFO_TAB, values, ChildInfo.SERVER_ID + "  = '" + serverid
                + "'", null);
    }
    ...
    void setSelectedChild(int childid) {
        ...
        db.update(SqliteHelper.CHILDREN_INFO_TAB, values, ChildInfo.ID + "  = " + childid, null);
    }
    ...
    ChildInfo getSelectedChild() {
        ChildInfo info = null;
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        Cursor cursor = db.rawQuery("SELECT * FROM " + SqliteHelper.CHILDREN_INFO_TAB + " WHERE "
    ...
    ChildInfo getSelectedChildByID(String id) {
        ChildInfo info = null;
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        Cursor cursor = db.rawQuery("SELECT * FROM " + SqliteHelper.CHILDREN_INFO_TAB + " WHERE "
