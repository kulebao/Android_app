...
public class DataMgr {
    ...
    public void deleteLocationInfo(int id) {
        ...
        db.execSQL("DELETE FROM " + SqliteHelper.LOCATION_TAB + " WHERE " + LocationInfo.ID + " = "
                + id);
    }
    ...
    public void deleteBindedNumInfo(int id) {
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        db.execSQL("DELETE FROM " + SqliteHelper.BINDED_NUM_TAB + " WHERE " + BindedNumInfo.ID
                + " = " + id);
    }
    ...
    public List<Notice> getAllNotice() {
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        Cursor cursor = db.rawQuery("SELECT * FROM " + SqliteHelper.NOTICE_TAB + " ORDER BY "
    ...
    public List<Notice> getAllNoticeByType(int type) {
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        Cursor cursor = db.rawQuery("SELECT * FROM " + SqliteHelper.NOTICE_TAB + " WHERE "
                + Notice.NOTICE_TYPE + " = " + type + " ORDER BY " + Notice.TIMESTAMP + " DESC",
                null);
    ...
    public List<Notice> getNoticeByType(int type, int max) {
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        Cursor cursor = db.rawQuery("SELECT * FROM " + SqliteHelper.NOTICE_TAB + " WHERE "
                + Notice.NOTICE_TYPE + " = " + type + " ORDER BY " + Notice.TIMESTAMP
                + " DESC LIMIT " + max, null);
    ...
    public void deleteNotice(int id) {
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        db.execSQL("DELETE FROM " + SqliteHelper.NOTICE_TAB + " WHERE " + Notice.ID + " = " + id);
    }
    ...
    public void removeAllNoticeByType(int type) {
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        db.execSQL("DELETE FROM " + SqliteHelper.NOTICE_TAB + " WHERE " + Notice.NOTICE_TYPE
                + " = " + type);
    }
    ...
    public void removeAllOtherNotice() {
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        db.execSQL("DELETE FROM " + SqliteHelper.NOTICE_TAB + " WHERE " + Notice.NOTICE_TYPE
                + " = " + JSONConstant.NOTICE_TYPE_OTHER);
    }
