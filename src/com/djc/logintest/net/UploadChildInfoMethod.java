...
public class UploadChildInfoMethod {
    ...
    public int uploadChildInfo(String content) {
    ...
    private String createUploadChildInfoUrl() {
        String url = String.format(ServerUrls.UPLOAD_CHILD_INFO, DataMgr.getInstance()
                .getSchoolID(), Utils.getProp(JSONConstant.ACCOUNT_NAME), DataMgr.getInstance()
