...
public class ResetPWDMethod {
    ...
    public int changePwd(String oldPwd, String newPwd, String account) {
        ...
        try {
            result = HttpsMethod.sendPostCommand(ServerUrls.CHANGE_PWD_URL, command);
    ...
    public int resetPwd(String authcode, String newPwd, String account) {
        ...
        try {
            result = HttpsMethod.sendPostCommand(ServerUrls.RESET_PWD_URL, command);
    ...
    private String createChangePWDCommand(String oldPwd, String newPwd, String account) {
    ...
    private String createResetPWDCommand(String authcode, String newPwd, String account) {
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put(JSONConstant.ACCOUNT_NAME, account);
