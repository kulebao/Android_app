...
public class HttpsMethod {
    ...
    public static HttpResult sendPostCommand(String url, String inCommand) throws IOException {
        ...
        try {
            connection = HttpsModel.createHttpsConnection(url, ConstantValue.HTTP_POST);
            connection.connect();
    ...
    public static int validatePhone(String url, String phonenum) throws IOException {
    ...
    public static int getResult(HttpsURLConnection connection) throws IOException,
    ...
    private static String getBindCommand(String phonenum, String userid, String channelid) {
