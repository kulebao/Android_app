...
public class SwipeCalendarActivity extends Activity {
    ...
    public void bindview() {
        ...
        ActivityHelper.setBackKeyLitsenerOnTopbar(this, R.string.swipe_calendar);
    ...
    public String getFormattedResult(String in) {
        ...
        String result = InfoHelper.HOUR_MINUTE_FORMAT.format(Date);
        return result;
    }
    ...
    private DateWidgetDayCell.OnItemClick mOnDayCellClick = new DateWidgetDayCell.OnItemClick() {
        public void OnClick(DateWidgetDayCell item) {
            if (!item.getRecord().isEmpty()) {
                ...
                String format = InfoHelper.YEAR_MONTH_DAY_FORMAT.format(date);
