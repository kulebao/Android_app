...
public class MainActivity extends TabActivity {
        ...
        handler = new MyHandler(this, null) {
            ...
            public void handleMessage(Message msg) {
                ...
                case EventType.HAS_NEW_VERSION:
                    Utils.showTwoBtnResDlg(R.string.update_now, MainActivity.this,
                            new OnClickListener() {
                                @Override
                ...
                case EventType.SERVER_INNER_ERROR:
                    Toast.makeText(MainActivity.this, R.string.get_child_info_fail,
                            Toast.LENGTH_SHORT);
                    break;
    ...
    private void runCheckUpdateTask() {
        ...
        uodateTask = new CheckUpdateTask(handler, Utils.getAccount(), Utils.getVersionCode())
                .execute();
    }
    ...
    private void initUI() {
        ...
        Class<?>[] classes = { SchoolNoticeActivity.class, LocationMgrActivity.class,
