...
public class LocationMgrActivity extends TabChildActivity {
        ...
        doLocBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (allBindedNumInfo.isEmpty()) {
                    Utils.showSingleBtnResDlg(R.string.pls_bind_lbs_num, LocationMgrActivity.this);
    ...
    private void showSingleChoiceDlg(List<BindedNumInfo> infos) {
        ...
        new AlertDialog.Builder(this).setTitle(R.string.choose_lbs_num)
                .setSingleChoiceItems(items, 0, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        Log.d("showSingleChoiceDlg", "whichButton =" + whichButton);
                        selectedBindedNumInfo = allBindedNumInfo.get(whichButton);
                        Log.d("showSingleChoiceDlg", "bindedNumInfo =" + selectedBindedNumInfo);
                    }
    ...
    private class SmsBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.d("DDD resultCode", "resultCode =" + resultCode + "  action=" + intent.getAction());
            switch (resultCode) {
            case Activity.RESULT_OK:
                // 短信发送成功
                Utils.showSingleBtnResDlg(R.string.sendsmsSuccess, LocationMgrActivity.this);
                break;
            default:
                Utils.showSingleBtnResDlg(R.string.sendsmsfail, LocationMgrActivity.this);
                break;
            }
