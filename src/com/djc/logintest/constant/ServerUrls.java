...
public class ServerUrls {
    ...
    // public static final String HOST_ADDR = "https://djcwebtest.duapp.com/";
    // public static final String HTTPS_HOST_ADDR =
    // "https://kulebao.herokuapp.com/";
    // public static final String HTTPS_HOST_ADDR = "https://115.28.7.205/";
    public static final String HTTPS_HOST_ADDR = "https://www.cocobabys.com/";

    public static final String CHECK_PHONE_NUM_URL = HTTPS_HOST_ADDR + "checkphonenum.do";
    // 注册时的验证码
    public static final String CHECK_REG_AUTH_CODE_URL = HTTPS_HOST_ADDR + "check_reg_authcode.do";

    public static final String SEND_BIND_INFO_URL = HTTPS_HOST_ADDR + "receiveBindInfo.do";
    public static final String LOGIN_URL = HTTPS_HOST_ADDR + "login.do";
    public static final String CHANGE_PWD_URL = HTTPS_HOST_ADDR + "changepwd.do";
    public static final String RESET_PWD_URL = HTTPS_HOST_ADDR + "resetpwd.do";

    public static final String GET_REG_AUTHCODE = HTTPS_HOST_ADDR + "get_reg_authcode.do";
    ...
    public static final String GET_SCHOOL_DETAIL = HTTPS_HOST_ADDR + ROOT_RES_PATH + "/%s/"
            + GET_TYPE_DETAIL;

    public static final String SCHEDULE_PRIVIEW = HTTPS_HOST_ADDR + ROOT_RES_PATH + "/%s/"
            + CLASS_RES_PATH + "/%s/" + SCHEDULE_RES_PATH + "/" + GET_TYPE_PREVIEW;

    public static final String GET_SCHEDULE = HTTPS_HOST_ADDR + ROOT_RES_PATH + "/%s/"
            + CLASS_RES_PATH + "/%s/" + SCHEDULE_RES_PATH + "/%s";

    public static final String COOKBOOK_PRIVIEW = HTTPS_HOST_ADDR + ROOT_RES_PATH + "/%s/"
            + COOKBOOK_RES_PATH + "/" + GET_TYPE_PREVIEW;

    public static final String COOKBOOK_DETAIL = HTTPS_HOST_ADDR + ROOT_RES_PATH + "/%s/"
            + COOKBOOK_RES_PATH + "/%s";
}
